...
values
("Publicaçao do Usuario 1", "Essa é a publicaçao do usuario 1!", 1),
("Publicaçao do Usuario 2", "Essa é a publicaçao do usuario 2!", 2),
("Publicaçao do Usuario 3", "Essa é a publicaçao do usuario 3!", 3);
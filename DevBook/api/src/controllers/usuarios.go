...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioId != usuarioIdNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Nao e posivel atualizar um usuario que nao seja o seu"))
		return
	}
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if seguidorId == usuarioId {
		respostas.Erro(w, http.StatusForbidden, errors.New("Nao é possivel parar de seguir voce mesmo"))
		return
	}
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioId != usuarioIdNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("Nao e possivel atualizar a senha de um usuario que nao seja o seu"))
		return
	}

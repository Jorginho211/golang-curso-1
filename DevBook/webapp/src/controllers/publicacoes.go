...
// CriarPublicacao chama a API para cadastrar uma nova publicaçao
...
// CurtirPublicacao chama a API para curtir uma publicaçao
...
// DescurtirPublicacao chama a API para descurtir uma publicaçao
...
// AtualizarPublicacao chama a API para atualizar uma publicaçao
...
// DeletarPublicacao chama a API para atualizar uma publicaçao
